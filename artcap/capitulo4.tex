...
\chaptermark{emplos de fórmulas y ecuaciones\dots}
...
\paragraph*{Explicación} El teorema fundamental del cálculo relaciona la integral definida de $f(x)$ con su antiderivada $F(x)$.

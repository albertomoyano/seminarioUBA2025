...
pdftk ./pdf/epub1-seminarioUBA.pdf cat 16-19 output ./docs/capitulo3-epub1-seminarioUBA.pdf
pdftk ./pdf/epub1-seminarioUBA.pdf cat 20-22 output ./docs/referencias-epub1-seminarioUBA.pdf
exit

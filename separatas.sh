...
pdftk ./pdf/pdf-seminarioUBA.pdf cat 25-28 output ./docs/capitulo2-pdf-seminarioUBA.pdf
...
pdftk ./pdf/pdf-seminarioUBA.pdf cat 35-47 output ./docs/indices-pdf-seminarioUBA.pdf
exit
